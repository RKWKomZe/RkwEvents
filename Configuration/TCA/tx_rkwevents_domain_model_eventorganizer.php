...
return [
	'ctrl' => [
		...
		'searchFields' => 'salutation,first_name,last_name,company,address,zip,city,phone,fax,email,show_pid,website_url',
	...
	'interface' => [
		...
		'showRecordFieldList' => 'sys_language_uid, l10n_parent, l10n_diffsource, hidden, company, show_pid, website_url',

	],
	'types' => [
		// '1' => ['showitem' => 'sys_language_uid, l10n_parent, l10n_diffsource, hidden,--palette--;;1, company, first_name, last_name, phone, email'],
		'1' => ['showitem' => 'sys_language_uid, l10n_parent, l10n_diffsource, hidden,--palette--;;1, company, show_pid, website_url'],
	...
	'columns' => [
        ...
        'website_url' => [
            'exclude' => 0,
            'label' => 'LLL:EXT:rkw_events/Resources/Private/Language/locallang_db.xlf:tx_rkwevents_domain_model_eventorganizer.website_url',
            'config' => [
                'type' => 'input',
