...
return [
	'ctrl' => [
        ...
        'label' => 'last_name',
		'label_alt' => 'first_name, reservation_reference',
	...
	'columns' => [
        ...
        'revocation_consent' => [
            'exclude' => 1,
            'label' => 'LLL:EXT:rkw_events/Resources/Private/Language/locallang_db.xlf:tx_rkwevents_domain_model_eventreservation.revocation_consent',
            'config' => [
                'type' => 'check',
                'default' => 0,
            ],
