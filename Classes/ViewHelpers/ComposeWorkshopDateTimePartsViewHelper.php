...
/**
 * Class ComposeWorkshopDateTimePartsViewHelper
 *
 ...
 */
class ComposeWorkshopDateTimePartsViewHelper extends \TYPO3Fluid\Fluid\Core\ViewHelper\AbstractViewHelper
{
    ...
    public static function renderStatic(
        ...
        // @toDo: Also set "event". And if the event only is a one day event, don't show the day of the workshops (only time)
